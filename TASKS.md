...
For computing the number of workers demanded the formula that we have followed is as follows 𝑦𝑖𝑡=𝛽̂𝑥𝑡+𝛿̂1𝑜1+𝛿̂2𝑜2. Indeed, the first column of xt shows historical data on unemployment of the industry average which was 15%,17% and 14% for managers, 6%, 6%, 5% for engineers and 23%, 27%, and 25% for operators. The yt matrix shows historical data on the industry average demand for workers which was  4,6 and 6  for managers, 13,12 ,13 for engineers and  7, 7 and 9 for operators. Moreover, the unemployment is expected to be 10% for managers, 4% for engineers, and 20% for operators at the end of the year. Finally, after carrying out computations using the python software it has been determined that the number of workers expected to be needed at the end of the year are 4 managers, 12 engineers and 7 operators.
