...
Given that the number of avaialbe workers is expected to be 1 manager, 1 operatora and 1 engineer and however, the number of workers needed are 4 managers, 12 egineers and 7 operators there would be a labor mismatch:  a shortage of 3 managers, 11 engineers and 6 operators. Then, an upsizing strategy would be needed to avoid the labor mismatch being hiring the most suitable strategy given that the shortage of workers is quite considerable. 
